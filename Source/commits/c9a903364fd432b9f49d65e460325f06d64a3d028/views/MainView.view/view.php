...
$pmvc = $appContent->getAppViewContainer('chat/PollPendingMessages', array(), true, 'diomsg-poll-pending-messages-view-container');
$mainContainer = HTML::select('#diomsg-main-container')->item(0);
HTML::append($mainContainer, $pmvc);
