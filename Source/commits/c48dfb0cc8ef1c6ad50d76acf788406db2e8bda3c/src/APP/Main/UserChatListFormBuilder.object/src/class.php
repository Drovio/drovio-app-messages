...
class UserChatListFormBuilder {
	...
	public function buildItem($chat) {
		$content = 'Sent at ' . $chat->getLastMessageAt()->format(ChatManager::DATE_TIME_LOCAL_FORMAT);
	
		$item = HTML::li($content, 'diomsg-user-chat-' . $chatId, 'diomsg-user-chat');
