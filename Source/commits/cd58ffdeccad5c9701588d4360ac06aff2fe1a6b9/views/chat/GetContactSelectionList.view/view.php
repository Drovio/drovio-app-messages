...
// Add possible recipients to CLF.
$options = array();
...
//
// TODO: Retrieve the owner and team IDs via DrovIO.
$ownerField = $clf->getInput("hidden", "diomsg-owner", 1);
$clf->append($ownerField);

$teamField = $clf->getInput("hidden", "diomsg-team", 1);
