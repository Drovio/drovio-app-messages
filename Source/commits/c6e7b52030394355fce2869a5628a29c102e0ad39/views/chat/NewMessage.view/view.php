...
$dbg = HTML::select("#diomsg-debug")->item(0);
$content = HTML::p("Content: " . $newMessageRequest->getContent());
$authorId = HTML::p("Author ID: " . $newMessageRequest->getAuthorId());
$chatId = HTML::p("Chat ID: " . $newMessageRequest->getChatId());
HTML::append($dbg, $content);
HTML::append($dbg, $authorId);
HTML::append($dbg, $chatId);
