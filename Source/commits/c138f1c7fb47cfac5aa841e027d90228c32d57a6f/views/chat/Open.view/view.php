...
// Close any currently active chat.
$ccvc = $appContent->getAppViewContainer(
	'chat/Close',
	array(CloseChatRequest::KEY_COMPLETE_CLOSE => '1'),
	false,
	'',
	false,
	true
...
$chatManager->activateChatForParticipant($chatId, $userAccountId);
$messages = $chatManager->findChatMessages($chatId, $userAccountId);
$chatManager->deletePendingMessagesOfChatParticipant($userAccountId, $chatId);
...
$pmvc = $appContent->getAppViewContainer(
	...
	array(
		GetMessagesFormBuilder::FIELD_NAME_CHAT_ID => $chatId,
		PollMessagesFormBuilder::FIELD_NAME_PARTICIPANT_ID => $userAccountId	
	),
	true,
