...
//			$this->getActionView(),
//			'',
//			array(GetMessagesFormBuilder::FIELD_NAME_CHAT_ID => $this->getChatIdFromChatListItem($chatListItem)),
//			false
//		);
	...
	public function buildItemWith($chatListItem) {
		...
		$chatId = $chat->getId();
		$openChatButton = $this->buildOpenChatButton($chatId);
...
//		$l = HTML::div('', '', 'diomsg-user-chat-list-participants-list');		
		
		$participants = $chat->getParticipants();
		$names = array();
		foreach ($participants as $p) {
			$names[] = $p->getName();
//			$li = HTML::li($p->getName() . ', ', '', 'diomsg-user-chat-list-participants-list-item');
//			HTML::append($l, $li);
		}
