...
var MainViewController = (function($) {
   ...
   *
   */
  MainViewController.prototype.addMessageToActiveChat = function(author, message, mine) {
    var messageContainer = this._buildChatMessageContainer(author, message, mine);
  ...
  MainViewController.prototype.onChatOpened = function(event, response) {
    ...
    $.each(messages, function(index, message) {
      controller.addMessageToActiveChat(message['author_name'], message['content'], message['mine']);
    });
  };
   ...
   *
   */
  MainViewController.prototype._buildChatMessageContainer = function(author, message, mine) {
    var containerCls = !mine ? this.options.presentation.floatRightCls : '';
