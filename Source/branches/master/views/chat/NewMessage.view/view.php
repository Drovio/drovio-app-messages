...
$messageManager = new ChatManager(new DatabaseConnectionBuilder(), new IdGenerator());
...
// Undelete the message's chat for all participants.
$messageManager->undeleteChat($newMessageRequest->getChatId());
